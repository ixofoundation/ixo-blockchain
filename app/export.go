...
// export the state of ixo for a genesis file
func (app *ixoApp) ExportAppStateAndValidators(forZeroHeight bool, jailWhiteList []string,
...
func (app *ixoApp) prepForZeroHeightGenesis(ctx sdk.Context, jailWhiteList []string) {
