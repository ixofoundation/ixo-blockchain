...
func GenerateOrBroadcastTxWithFactory(clientCtx client.Context, txf tx.Factory, ixoDid exported.IxoDid, msgs ...sdk.Msg) error {
...
func BroadcastTx(clientCtx client.Context, txf tx.Factory, signer exported.IxoDid, ...msg sdk.Msg) error {
