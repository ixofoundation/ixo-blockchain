...
import (
	...
	ixo "github.com/ixofoundation/ixo-blockchain/v3/app"
...
Example:
	ixod testnet init-files --v 4 --output-dir ./.testnets --starting-ip-address 192.168.10.2
	`,
	...
	cmd.Flags().String(flagNodeDaemonHome, "ixod", "Home directory of the node's daemon configuration")
...
Example:
	ixod testnet --v 4 --output-dir ./.testnets
	`,
		RunE: func(cmd *cobra.Command, _ []string) error {
			args := startArgs{}
			args.outputDir, _ = cmd.Flags().GetString(flagOutputDir)
...
func startTestnet(cmd *cobra.Command, args startArgs) error {
	networkConfig := network.DefaultConfig(ixo.NewTestNetworkFixture)
