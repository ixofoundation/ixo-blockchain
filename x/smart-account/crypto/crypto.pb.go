...
type AuthnPubKey struct {
	...
	RelayingPartyId []byte `protobuf:"bytes,4,opt,name=relaying_party_id,json=relayingPartyId,proto3" json:"relaying_party_id,omitempty"`
}
...
func (m *AuthnPubKey) GetRelayingPartyId() []byte {
	if m != nil {
		return m.RelayingPartyId
	}
	return nil
}
...
var fileDescriptor_e21e0a2358462521 = []byte{
	...
	0xa2, 0x56, 0x4a, 0x24, 0x3d, 0x3f, 0x3d, 0x1f, 0xcc, 0xd4, 0x07, 0xb1, 0x20, 0xa2, 0x4a, 0x87,
	...
	,
}
...
func (m *AuthnPubKey) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if len(m.RelayingPartyId) > 0 {
		i -= len(m.RelayingPartyId)
		copy(dAtA[i:], m.RelayingPartyId)
		i = encodeVarintCrypto(dAtA, i, uint64(len(m.RelayingPartyId)))
		i--
		dAtA[i] = 0x22
	}
	if len(m.Key) > 0 {
...
func (m *AuthnPubKey) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 4:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field RelayingPartyId", wireType)
			}
			var byteLen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.RelayingPartyId = append(m.RelayingPartyId[:0], dAtA[iNdEx:postIndex]...)
			if m.RelayingPartyId == nil {
				m.RelayingPartyId = []byte{}
			}
			iNdEx = postIndex
		default:
			iNdEx = preIndex
