...
func TestKeeperEffectPayment(t *testing.T) {
	...
	// PayMin:  3res
	// PayMax:  /
	// Next payment expected to be: 1ixo, 3res (3res due to PayMin)
	...
	// PayMin:  3res
	// PayMax:  /
	// Next payment expected to be: 1ixo, 2res (no effect from PayMin)
	...
	// Next payment expected to be: 1ixo, 2res
...
func TestKeeperEffectPaymentWithDiscounts(t *testing.T) {
	...
	// At this point, cumulative: /
	// PayAmt:  2ixo, 4res (discounted to 1ixo, 2res)
	// PayMin:  3res
	// PayMax:  /
	// Next payment expected to be: 1ixo, 3res (3res due to PayMin)
	// Updated balance: 9ixo, 7res
