...
var (
	...
	ErrNegativeDiscountPercentage                   = sdkErrors.Register(DefaultCodespace, 115, "discount percentage must be positive")
	ErrDiscountPercentageGreaterThan100             = sdkErrors.Register(DefaultCodespace, 116, "discount percentage cannot exceed 100")
	...
	ErrInvalidId                                    = sdkErrors.Register(DefaultCodespace, 117, "creator did is invalid")
