...
//}
//
//func queryPaymentTemplateHandler(cliCtx client.Context) http.HandlerFunc {
...
//		if err := cliCtx.LegacyAmino.UnmarshalJSON(bz, &template); err != nil {
//			w.WriteHeader(http.StatusInternalServerError)
...
//}
//
//func queryPaymentContractHandler(cliCtx client.Context) http.HandlerFunc {
//	return func(w http.ResponseWriter, r *http.Request) {
//		vars := mux.Vars(r)
...
//		if err := cliCtx.LegacyAmino.UnmarshalJSON(bz, &contract); err != nil {
//			w.WriteHeader(http.StatusInternalServerError)
//			_, _ = w.Write([]byte(fmt.Sprintf("Couldn't Unmarshal data %s", err.Error())))
//			return
//		}
...
//}
//
//func querySubscriptionHandler(cliCtx client.Context) http.HandlerFunc {
//	return func(w http.ResponseWriter, r *http.Request) {
//		vars := mux.Vars(r)
...
//		if err := cliCtx.LegacyAmino.UnmarshalJSON(bz, &subscription); err != nil {
//			w.WriteHeader(http.StatusInternalServerError)
//			_, _ = w.Write([]byte(fmt.Sprintf("Couldn't Unmarshal data %s", err.Error())))
//			return
//		}
