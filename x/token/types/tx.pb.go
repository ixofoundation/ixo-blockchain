...
import (
	...
	_ "github.com/ixofoundation/ixo-blockchain/v8/x/iid/types"
...
type MsgCreateToken struct {
	...
	Class github_com_ixofoundation_ixo_blockchain_v6_x_iid_types.DIDFragment `protobuf:"bytes,2,opt,name=class,proto3,casttype=github.com/ixofoundation/ixo-blockchain/v8/x/iid/types.DIDFragment" json:"class,omitempty"`
...
func (m *MsgCreateToken) GetClass() github_com_ixofoundation_ixo_blockchain_v6_x_iid_types.DIDFragment {
	if m != nil {
		return m.Class
	}
	return ""
...
var fileDescriptor_bb958a4ae6c01cf1 = []byte{
	...
	0x29, 0x90, 0x5d, 0xa5, 0x08, 0x84, 0xc2, 0x01, 0x91, 0x84, 0x4a, 0x3d, 0x58, 0x42, 0x4b, 0x2a,
	...
	0x7f, 0x80, 0x69, 0xec, 0x1e, 0xbc, 0xed, 0x8e, 0x55, 0xd7, 0xe2, 0x61, 0x42, 0xb8, 0xb3, 0x73,
	...
	0x80, 0xde, 0x82, 0xaa, 0xca, 0xc9, 0xed, 0xb2, 0xaa, 0x6f, 0x65, 0x5e, 0x7d, 0x5a, 0x89, 0x0c,
	...
	0x00, 0x00, 0x00, 0xff, 0xff, 0x0c, 0x93, 0x2f, 0x7a, 0x9a, 0x0b, 0x00, 0x00,
}
...
func (m *MsgCreateToken) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.Class = github_com_ixofoundation_ixo_blockchain_v6_x_iid_types.DIDFragment(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
