...
func (*MsgStopToken) Descriptor() ([]byte, []int) {
	return fileDescriptor_bb958a4ae6c01cf1, []int{16}
}
...
func (*MsgStopTokenResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_bb958a4ae6c01cf1, []int{17}
}
...
func init() {
	...
	proto.RegisterType((*MsgTransferCredit)(nil), "ixo.token.v1beta1.MsgTransferCredit")
	proto.RegisterType((*MsgTransferCreditResponse)(nil), "ixo.token.v1beta1.MsgTransferCreditResponse")
...
var fileDescriptor_bb958a4ae6c01cf1 = []byte{
	...
	,
}
...
func (c *msgClient) TransferCredit(ctx context.Context, in *MsgTransferCredit, opts ...grpc.CallOption) (*MsgTransferCreditResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ixo.token.v1beta1.Msg/TransferCredit", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_TransferCredit_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ixo.token.v1beta1.Msg/TransferCredit",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
