...
func (didDoc *DidDocument) AddLinkedResource(linkedResources ...*LinkedResource) (err error) {
...
func (didDoc *DidDocument) DeleteLinkedResource(resourceID string) {
	del := func(x int) {
...
func (didDoc *DidDocument) AddAccordedRight(accordedRights ...*AccordedRight) (err error) {
...
func (didDoc *DidDocument) DeleteAccordedRight(rightID string) {
	del := func(x int) {
