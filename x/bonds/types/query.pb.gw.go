...
var (
	pattern_Query_Bonds_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 1}, []string{"ixo", "bonds"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_BondsDetailed_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"ixo", "bonds", "bonds_detailed"}, "", runtime.AssumeColonVerbOpt(false)))
	...
	pattern_Query_AvailableReserve_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 1, 0, 4, 1, 5, 2, 2, 3}, []string{"ixo", "bonds", "bond_did", "available_reserve"}, "", runtime.AssumeColonVerbOpt(false)))
