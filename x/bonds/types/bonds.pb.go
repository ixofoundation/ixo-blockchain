...
type Bond struct {
	...
	CreatorDid                   github_com_ixofoundation_ixo_blockchain_v4_x_iid_types.DIDFragment `protobuf:"bytes,4,opt,name=creator_did,json=creatorDid,proto3,casttype=github.com/ixofoundation/ixo-blockchain/v4/x/iid/types.DIDFragment" json:"creator_did,omitempty"`
	ControllerDid                github_com_ixofoundation_ixo_blockchain_v4_x_iid_types.DIDFragment `protobuf:"bytes,5,opt,name=controller_did,json=controllerDid,proto3,casttype=github.com/ixofoundation/ixo-blockchain/v4/x/iid/types.DIDFragment" json:"controller_did,omitempty"`
	...
	OracleDid                    github_com_ixofoundation_ixo_blockchain_v4_x_iid_types.DIDFragment `protobuf:"bytes,28,opt,name=oracle_did,json=oracleDid,proto3,casttype=github.com/ixofoundation/ixo-blockchain/v4/x/iid/types.DIDFragment" json:"oracle_did,omitempty"`
}
...
func (m *Bond) GetCreatorDid() github_com_ixofoundation_ixo_blockchain_v4_x_iid_types.DIDFragment {
	if m != nil {
		return m.CreatorDid
	}
	return ""
...
func (m *Bond) GetControllerDid() github_com_ixofoundation_ixo_blockchain_v4_x_iid_types.DIDFragment {
	if m != nil {
...
func (m *Bond) GetOracleDid() github_com_ixofoundation_ixo_blockchain_v4_x_iid_types.DIDFragment {
	if m != nil {
		return m.OracleDid
	}
	return ""
...
type BaseOrder struct {
	AccountDid   github_com_ixofoundation_ixo_blockchain_v4_x_iid_types.DIDFragment `protobuf:"bytes,1,opt,name=account_did,json=accountDid,proto3,casttype=github.com/ixofoundation/ixo-blockchain/v4/x/iid/types.DIDFragment" json:"account_did,omitempty"`
...
func (m *BaseOrder) GetAccountDid() github_com_ixofoundation_ixo_blockchain_v4_x_iid_types.DIDFragment {
	if m != nil {
		return m.AccountDid
	}
	return ""
...
var fileDescriptor_93b4137e78081347 = []byte{
	...
	0x42, 0xb2, 0xd8, 0xf5, 0x9f, 0x44, 0xb6, 0xac, 0x28, 0x12, 0x1b, 0x44, 0x84, 0xe2, 0xc4, 0x64,
	...
	0xbd, 0x76, 0xbf, 0xcd, 0x79, 0x54, 0x44, 0x76, 0x67, 0x6b, 0x3b, 0xa3, 0xbd, 0x84, 0x09, 0xed,
	...
	0x0f, 0xe3, 0xdd, 0x7c, 0x60, 0xc7, 0xe1, 0xea, 0xcd, 0x2b, 0xaf, 0xbb, 0xb3, 0xae, 0xe0, 0x5d,
	...
	0x76, 0xcb, 0xf8, 0x11, 0x7f, 0xeb, 0xdf, 0x00, 0x00, 0x00, 0xff, 0xff, 0x01, 0x0f, 0x1f, 0x63,
	0x49, 0x10, 0x00, 0x00,
}
...
func (m *BaseOrder) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.AccountDid = github_com_ixofoundation_ixo_blockchain_v4_x_iid_types.DIDFragment(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
