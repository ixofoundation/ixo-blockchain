...
type Bond struct {
	...
	CreatorDid                   github_com_ixofoundation_ixo_blockchain_x_iid_types.DIDFragment `protobuf:"bytes,4,opt,name=creator_did,json=creatorDid,proto3,casttype=github.com/ixofoundation/ixo-blockchain/x/iid/types.DIDFragment" json:"creator_did,omitempty" yaml:"creator_did"`
	ControllerDid                github_com_ixofoundation_ixo_blockchain_x_iid_types.DIDFragment `protobuf:"bytes,5,opt,name=controller_did,json=controllerDid,proto3,casttype=github.com/ixofoundation/ixo-blockchain/x/iid/types.DIDFragment" json:"controller_did,omitempty" yaml:"controller_did"`
	...
	OracleDid                    github_com_ixofoundation_ixo_blockchain_x_iid_types.DIDFragment `protobuf:"bytes,28,opt,name=oracle_did,json=oracleDid,proto3,casttype=github.com/ixofoundation/ixo-blockchain/x/iid/types.DIDFragment" json:"oracle_did,omitempty" yaml:"oracle_did"`
}
