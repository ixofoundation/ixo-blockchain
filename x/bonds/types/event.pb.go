...
type BondBuyOrderFulfilledEvent struct {
	...
	NewBondTokenBalance         github_com_cosmos_cosmos_sdk_types.Int   `protobuf:"bytes,6,opt,name=new_bond_token_balance,json=newBondTokenBalance,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"new_bond_token_balance"`
	ChargedPricesOfWhichReserve *github_com_cosmos_cosmos_sdk_types.Int  `protobuf:"bytes,7,opt,name=charged_prices_of_which_reserve,json=chargedPricesOfWhichReserve,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"charged_prices_of_which_reserve,omitempty"`
...
type BondSellOrderFulfilledEvent struct {
	...
	NewBondTokenBalance github_com_cosmos_cosmos_sdk_types.Int   `protobuf:"bytes,5,opt,name=new_bond_token_balance,json=newBondTokenBalance,proto3,customtype=github.com/cosmos/cosmos-sdk/types.Int" json:"new_bond_token_balance"`
}
...
var fileDescriptor_8b836af92b7c9cac = []byte{
	...
	,
}
