...
var (
	...
	ErrArgumentCannotBeEmpty                = sdkErrors.Register(DefaultCodespace, 333, " argument cannot be empty")
	...
	ErrArgumentMissingOrNonBoolean          = sdkErrors.Register(DefaultCodespace, 343, "argument is missing or is not true or false")
	ErrIncorrectNumberOfReserveTokens       = sdkErrors.Register(DefaultCodespace, 303, "Incorrect number of reserve tokens")
	ErrIncorrectNumberOfFunctionParameters  = sdkErrors.Register(DefaultCodespace, 344, "Incorrect number of function parameters")
	...
	ErrBondTokenIsTaken                     = sdkErrors.Register(DefaultCodespace, 345, "Bond token is taken")
	...
	ErrInvalidFunctionParameter             = sdkErrors.Register(DefaultCodespace, 346, "Invalid function parameter")
	...
	ErrFunctionRequiresNonZeroCurrentSupply = sdkErrors.Register(DefaultCodespace, 347, "Function requires the current supply to be non zero")
	...
	ErrBondTokenCannotBeStakingToken        = sdkErrors.Register(DefaultCodespace, 348, "Bond token cannot be staking token")
	...
	ErrCannotBurnMoreThanSupply             = sdkErrors.Register(DefaultCodespace, 349, "Cannot burn more tokens than the current supply")
	...
	ErrSwapAmountCausesReserveDepletion     = sdkErrors.Register(DefaultCodespace, 350, "swap amount too large and causes  reserve to be depleted")
	...
	ErrNoBondTokensOwned                    = sdkErrors.Register(DefaultCodespace, 351, "No bond tokens of this bond are owned")
