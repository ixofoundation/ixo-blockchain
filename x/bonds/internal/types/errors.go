...
var (
	...
	ErrArgumentCannotBeEmpty                = sdkErrors.Register(DefaultCodespace, 332, " argument cannot be empty")
	ErrArgumentCannotBeNegative             = sdkErrors.Register(DefaultCodespace, 332, "argument cannot be negative")
	ErrArgumentMustBePositive               = sdkErrors.Register(DefaultCodespace, 332, "argument must be a positive value")
	ErrArgumentMustBeInteger                = sdkErrors.Register(DefaultCodespace, 332, "argument must be an integer value")
	ErrArgumentMustBeBetween                = sdkErrors.Register(DefaultCodespace, 332, "\"%s argument must be between %s and %s\", arg, a, b")
	ErrFunctionParameterMissingOrNonFloat   = sdkErrors.Register(DefaultCodespace, 332, "parameter is missing or is not a float")
