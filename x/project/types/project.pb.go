...
type CreateAgentDoc struct {
	AgentDid string `protobuf:"bytes,1,opt,name=agent_did,json=agentDid,proto3" json:"agent_did,omitempty" yaml:"did"`
...
type CreateClaimDoc struct {
	ClaimId         string `protobuf:"bytes,1,opt,name=claim_id,json=claimId,proto3" json:"claim_id,omitempty" yaml:"claimID"`
	ClaimTemplateId string `protobuf:"bytes,2,opt,name=claim_template_id,json=claimTemplateId,proto3" json:"claim_template_id,omitempty" yaml:"claimTemplateID"`
}
...
var fileDescriptor_2cf0ca921a221351 = []byte{
	...
	,
}
