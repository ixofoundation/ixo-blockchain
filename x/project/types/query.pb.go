...
type QueryProjectAccountsResponse struct {
	AccountMap map[string]string `protobuf:"bytes,1,rep,name=account_map,json=accountMap,proto3" json:"account_map,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func (m *QueryProjectAccountsResponse) GetAccountMap() map[string]string {
	if m != nil {
		return m.AccountMap
	}
	return nil
...
type QueryProjectTxResponse struct {
	Txs []*WithdrawalInfoDoc `protobuf:"bytes,1,rep,name=txs,proto3" json:"txs,omitempty"`
}
...
func (m *QueryProjectTxResponse) GetTxs() []*WithdrawalInfoDoc {
	if m != nil {
		return m.Txs
	}
	return nil
...
func init() {
	...
	proto.RegisterMapType((map[string]string)(nil), "project.QueryProjectAccountsResponse.AccountMapEntry")
...
var fileDescriptor_3d559d5280efda17 = []byte{
	...
	,
}
...
func (m *QueryProjectAccountsResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.AccountMap == nil {
				m.AccountMap = make(map[string]string)
			}
			var mapkey string
			var mapvalue string
			for iNdEx < postIndex {
...
func (m *QueryProjectTxResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Txs = append(m.Txs, &WithdrawalInfoDoc{})
