...
// GetTrend - returns the current project trend
...
// CheckTrend - Returns true or false based on whether guessedTrend is currently project or not
...
func (k Keeper) InitGenesis(ctx sdk.Context, data ProjectGenesis) error {
