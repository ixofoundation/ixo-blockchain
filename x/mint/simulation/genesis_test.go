...
import (
	...
	"github.com/ixofoundation/ixo-blockchain/v3/x/mint/simulation"
...
func TestRandomizedGenState(t *testing.T) {
	...
	simState := module.SimulationState{
		...
		InitialStake: ixomath.NewInt(1000),
	...
	epochProvisionsDec, err := ixomath.NewDecFromStr(expectedEpochProvisionsStr)
	...
	// Reduction factor.
	reductionFactorDec, err := ixomath.NewDecFromStr(expectedReductionFactorStr)
	require.NoError(t, err)
	...
	// Weighted impact rewards receivers.
	require.Equal(t, simulation.ExpectedImpactRewardReceivers, mintGenesis.Params.WeightedImpactRewardsReceivers)
