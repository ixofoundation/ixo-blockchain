...
ixod_tx did add-did-doc "$ORACLE_DID_FULL"
ixod_tx did add-did-doc "$IXO_DID_FULL"
...
ixod_tx did add-did-doc "$OWNER_DID_FULL"
...
ixod_tx bank send miguel "$OWNER_ADDR" 300000000uxgbp
...
ixod_tx bank send miguel "$PROJECT_ADDR" 100000000uxgbp
ixod_tx bank send miguel "$PROJECT_ADDR" 1000000000uixo
...
ixod_tx project create-claim "tx_hash" "$DID_1" "claim1" "template_id" "$PROJECT_DID_FULL"
ixod_tx project create-claim "tx_hash" "$DID_2" "claim2" "template_id" "$PROJECT_DID_FULL"
ixod_tx project create-claim "tx_hash" "$DID_3" "claim3" "template_id" "$PROJECT_DID_FULL"
ixod_tx project create-claim "tx_hash" "$DID_4" "claim4" "template_id" "$PROJECT_DID_FULL"
ixod_tx project create-claim "tx_hash" "$DID_5" "claim5" "template_id" "$PROJECT_DID_FULL"
ixod_tx project create-claim "tx_hash" "$DID_6" "claim6" "template_id" "$PROJECT_DID_FULL"
ixod_tx project create-claim "tx_hash" "$DID_7" "claim7" "template_id" "$PROJECT_DID_FULL"
ixod_tx project create-claim "tx_hash" "$DID_8" "claim8" "template_id" "$PROJECT_DID_FULL"
ixod_tx project create-claim "tx_hash" "$DID_9" "claim9" "template_id" "$PROJECT_DID_FULL"
ixod_tx project create-claim "tx_hash" "$DID_10" "claim10" "template_id" "$PROJECT_DID_FULL"

# Create evaluations
echo "Creating evaluations in project..."
STATUS="1"
ixod_tx project create-evaluation "tx_hash" "$DID_1" "claim1" "$STATUS" "$PROJECT_DID_FULL"
ixod_tx project create-evaluation "tx_hash" "$DID_2" "claim2" "$STATUS" "$PROJECT_DID_FULL"
ixod_tx project create-evaluation "tx_hash" "$DID_3" "claim3" "$STATUS" "$PROJECT_DID_FULL"
ixod_tx project create-evaluation "tx_hash" "$DID_4" "claim4" "$STATUS" "$PROJECT_DID_FULL"
ixod_tx project create-evaluation "tx_hash" "$DID_5" "claim5" "$STATUS" "$PROJECT_DID_FULL"
ixod_tx project create-evaluation "tx_hash" "$DID_6" "claim6" "$STATUS" "$PROJECT_DID_FULL"
ixod_tx project create-evaluation "tx_hash" "$DID_7" "claim7" "$STATUS" "$PROJECT_DID_FULL"
ixod_tx project create-evaluation "tx_hash" "$DID_8" "claim8" "$STATUS" "$PROJECT_DID_FULL"
ixod_tx project create-evaluation "tx_hash" "$DID_9" "claim9" "$STATUS" "$PROJECT_DID_FULL"
ixod_tx project create-evaluation "tx_hash" "$DID_10" "claim10" "$STATUS" "$PROJECT_DID_FULL"
...
ixod_tx bonds buy 1000000uabc 1000000uxgbp "$BOND_DID" "$DID_1_FULL"
echo "DID 2 buys 0.26ABC..."
ixod_tx bonds buy 259921uabc 1000000uxgbp "$BOND_DID" "$DID_2_FULL"
echo "DID 3 buys 0.18ABC..."
ixod_tx bonds buy 182328uabc 1000000uxgbp "$BOND_DID" "$DID_3_FULL"
echo "DID 4 buys 0.14ABC..."
ixod_tx bonds buy 145151uabc 1000000uxgbp "$BOND_DID" "$DID_4_FULL"
echo "DID 5 buys 0.12ABC..."
ixod_tx bonds buy 122574uabc 1000000uxgbp "$BOND_DID" "$DID_5_FULL"

# Make outcome payment
echo "Owner makes outcome payment..."
ixod_tx bonds make-outcome-payment "$BOND_DID" 100000000 "$OWNER_DID_FULL"
...
ixod_tx bonds withdraw-share "$BOND_DID" "$DID_1_FULL"
ixod_tx bonds withdraw-share "$BOND_DID" "$DID_2_FULL"
ixod_tx bonds withdraw-share "$BOND_DID" "$DID_3_FULL"
ixod_tx bonds withdraw-share "$BOND_DID" "$DID_4_FULL"
ixod_tx bonds withdraw-share "$BOND_DID" "$DID_5_FULL"
