...
sed -i 's/timeout_commit = "5s"/timeout_commit = "2s"/g' "$HOME"/.ixod/config/config.toml
sed -i 's/timeout_propose = "3s"/timeout_propose = "2s"/g' "$HOME"/.ixod/config/config.toml
