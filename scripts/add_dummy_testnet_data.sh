...
ixocli tx bonds buy 5token1 "100000res" did:ixo:U7GK8p8rVhJMKhBVRCJJ8c "$MIGUEL_DID_FULL" --broadcast-mode block
echo "Buying 5token2 from Miguel..."
ixocli tx bonds buy 5token2 "100000res" did:ixo:JHcN95bkS4aAWk3TKXapA2 "$MIGUEL_DID_FULL" --broadcast-mode block

# Buy token2 and token3 from Francesco and Shaun
echo "Buying 5token2 from Francesco..."
ixocli tx bonds buy 5token2 "100000res" did:ixo:JHcN95bkS4aAWk3TKXapA2 "$FRANCESCO_DID_FULL" --broadcast-mode block
echo "Buying 5token3 from Shaun..."
ixocli tx bonds buy 5token3 "100res,100rez" did:ixo:48PVm1uyF6QVDSPdGRWw4T "$SHAUN_DID_FULL" --broadcast-mode block

# Buy 5token4 from Miguel (using token1 and token2)
echo "Buying 5token4 from Miguel..."
ixocli tx bonds buy 5token4 "2token1,2token2" did:ixo:RYLHkfNpbA8Losy68jt4yF "$MIGUEL_DID_FULL" --broadcast-mode block
