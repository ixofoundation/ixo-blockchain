...
docker build -t trustlab/ixo-blockchain -f - ../ < $ROOT_DIR/docker/blockchain/Dockerfile
docker build -t trustlab/ixo-blockchain-rest -f - ../ < $ROOT_DIR/docker/rest/Dockerfile
docker-compose up -d
