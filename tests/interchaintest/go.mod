module github.com/ixofoundation/ixo-blockchain/v6/tests/interchaintest
...
// Replaces required to resolve transitive phantom versions in the
// interchaintest -> tendermint -> gogo/protobuf and interchaintest ->
// polkadot -> ChainSafe/go-schnorrkel chains. Same set juno and other
// chains use.
replace (
	...
	github.com/ixofoundation/ixo-blockchain/v6 => ../..
)
